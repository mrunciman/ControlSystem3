    ...
    case 3:
      if (sampFlag == true) {
        ...
        if (calibFlag == true){
          ...
          // stepCount = 0; - THIS NOW IS SET IN BWD EXTERNAL INTERRUPT ROUTINE
          // Notify that calibration is done
          writeSerial('P');
          TCCR1B &= (0 << CS11); // Turn off pulse stream
          // Change microstepping to 3200 steps per rev, otherwise known as 16 microsteps 
          digitalWrite(M0, LOW);
          digitalWrite(M1, LOW);
